<div align="center">
  ...
  <h3 align="center">HireMind: A job interview preparation platform powered by Vapi AI Voice agents</h3>
  <p align="center">Created and Updated by <b>Pradnyesh Ravane</b></p>
...
Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, styled with TailwindCSS and using Vapi's voice agents, HireMind is a website project designed to help you learn integrating AI models with your apps. The platform offers a sleek and modern experience for job interview preparation.

If you're getting started and need assistance or face any bugs, feel free to raise an issue in this repository.
...
```bash
git clone https://github.com/PradnyeshR/HIreMind-AI-based-mock-interview-prep-platform.git
