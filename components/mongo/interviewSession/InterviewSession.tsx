...
export default function InterviewSession({
  ...
  const saveCurrentAnswer = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/interview-ai/${interview._id}/answer`, {
        method: "POST",
        headers: {
      ...
      if (
        ...
        try {
          ...
          const completeResponse = await fetch(
            `/api/interview-ai/${interview._id}/complete`,
            {
              method: "POST",
              headers: {
                Authorization: `Bearer ${token}`,
          ...
          window.location.href = `/interview-ai/${interview._id}/results`;
