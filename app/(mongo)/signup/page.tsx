...
import MainBtn from "@/components/mongo/auth-components/MainBtn";
import Input from "@/components/mongo/auth-components/Input";
import OAuthBtn from "@/components/mongo/auth-components/OAuthBtn";
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setDebug(
        (prev) =>
          prev + `Sending request to /api/auth-ai/signup with email: ${email}\n`
      );

      const response = await fetch("/api/auth-ai/signup", {
        method: "POST",
        headers: {
