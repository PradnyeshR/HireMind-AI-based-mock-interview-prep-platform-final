...
import Loader from "@/components/mongo/Loader";
import ErrorInterview from "@/components/mongo/errors/ErrorInterview";
import ResultsNav from "@/components/mongo/ResultsPage/ResultsNav";
import ResultTabBtn from "@/components/mongo/ResultsPage/ResultTabBtn";
import InterviewDetails from "@/components/mongo/ResultsPage/InterviewDetails";
import OverviewTabData from "@/components/mongo/ResultsPage/OverviewTabData";
import FeedbackTabData from "@/components/mongo/ResultsPage/FeedbackTabData";
import InterviewNav from "@/components/mongo/interview/InterviewNav";
  ...
  useEffect(() => {
    const fetchInterview = async () => {
      try {
        ...
        const response = await fetch(`/api/interview-ai/${interviewId}`, {
          headers: {
        ...
        if (data.interview.status != "completed") {
          ...
          router.push(`/interview-ai/${interviewId}`);
          return;
        }
