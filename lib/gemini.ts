...
export const generateInterviewFeedback = async (
    ...
    try {
      ...
      `;
        ...
        const prompt = `Generate comprehensive interview feedback based on the following interview for a ${interview.jobRole
            } position with ${interview.yearsOfExperience
